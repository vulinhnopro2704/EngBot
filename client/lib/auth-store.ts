    ...
    (set, get) => ({
      ...
      login: async (email: string, password: string) => {
        ...
        try {
          ...
          const user = dummyUsers.find((u) => u.email.toLowerCase() === email.toLowerCase() && u.password === password)
      ...
      signup: async (name: string, email: string, password: string) => {
        ...
        try {
          ...
          const existingUser = dummyUsers.find((u) => u.email.toLowerCase() === email.toLowerCase())
