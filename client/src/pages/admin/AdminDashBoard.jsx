        ...
        <PageTransition>
            <div className="max-w-7xl mx-auto">
                <motion.div className="mb-8 flex justify-between items-center" variants={itemVariants}>
                    <div>
                        <h1 className="text-3xl font-bold text-gray-800 dark:text-gray-100 transition-colors duration-200">Admin Dashboard</h1>
                        <p className="text-gray-600 dark:text-gray-400 mt-2 transition-colors duration-200">Overview of your learning platform</p>
                    </div>
                    ...
                    {stats.map((stat, index) => (
                        ...
                        >
                            <div className="flex items-center justify-between mb-4">
                                ...
                                <div className={`flex items-center ${stat.trend === 'up' ? 'text-green-500 dark:text-green-400' : 'text-red-500 dark:text-red-400'} transition-colors duration-200`}>
                            ...
                            <h3 className="text-2xl font-bold text-gray-800 dark:text-gray-100 transition-colors duration-200">{stat.value}</h3>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                    ...
                    >
                        <div className="flex justify-between items-center mb-6">
                            <h2 className="text-xl font-bold text-gray-800 dark:text-gray-100 transition-colors duration-200">User Activity</h2>
                            <div className="flex space-x-2">
                                <div className="flex items-center">
                                    <div className="w-3 h-3 rounded-full bg-emerald-500 mr-1"></div>
                                    <span className="text-xs text-gray-500 dark:text-gray-400 transition-colors duration-200">New Users</span>
                                </div>
                                <div className="flex items-center">
                                    <div className="w-3 h-3 rounded-full bg-blue-500 mr-1"></div>
                                    <span className="text-xs text-gray-500 dark:text-gray-400 transition-colors duration-200">Active Users</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="h-64 flex items-end justify-between">
                            {['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'].map((day, index) => (
                                <div key={day} className="flex flex-col items-center w-1/7">
                                    ...
                                    <span className="text-xs text-gray-500 dark:text-gray-400 mt-2 transition-colors duration-200">{day}</span>
                                </div>
                            ))}
                        </div>
                    </motion.div>
                    ...
                    <motion.div
                        ...
                        variants={itemVariants}
                    >
                        <h2 className="text-xl font-bold text-gray-800 dark:text-gray-100 mb-6 transition-colors duration-200">Platform Stats</h2>

                        <div className="space-y-6">
                            <div>
                                <div className="flex justify-between items-center mb-2">
                                    <span className="text-sm text-gray-600 dark:text-gray-400 transition-colors duration-200">User Retention</span>
                                    <span className="text-sm font-medium text-gray-800 dark:text-gray-200 transition-colors duration-200">78%</span>
                                </div>
                            ...
                            <div>
                                <div className="flex justify-between items-center mb-2">
                                    <span className="text-sm text-gray-600 dark:text-gray-400 transition-colors duration-200">Content Engagement</span>
                                    <span className="text-sm font-medium text-gray-800 dark:text-gray-200 transition-colors duration-200">92%</span>
                                </div>
                                <div className="w-full h-2 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden transition-colors duration-200">
                                    <motion.div
                            ...
                            <div>
                                <div className="flex justify-between items-center mb-2">
                                    <span className="text-sm text-gray-600 dark:text-gray-400 transition-colors duration-200">Quiz Completion</span>
                                    <span className="text-sm font-medium text-gray-800 dark:text-gray-200 transition-colors duration-200">64%</span>
                                </div>
                                <div className="w-full h-2 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden transition-colors duration-200">
                                    <motion.div
                            ...
                            <div>
                                <div className="flex justify-between items-center mb-2">
                                    <span className="text-sm text-gray-600 dark:text-gray-400 transition-colors duration-200">Daily Active Users</span>
                                    <span className="text-sm font-medium text-gray-800 dark:text-gray-200 transition-colors duration-200">85%</span>
                                </div>
                                <div className="w-full h-2 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden transition-colors duration-200">
                                    <motion.div
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                    ...
                    >
                        <div className="flex justify-between items-center mb-6">
                            <h2 className="text-xl font-bold text-gray-800 dark:text-gray-100 transition-colors duration-200">Recent Users</h2>
                    ...
                    >
                        <div className="flex justify-between items-center mb-6">
                            <h2 className="text-xl font-bold text-gray-800 dark:text-gray-100 transition-colors duration-200">Popular Content</h2>
                            <button className="text-sm text-emerald-600 dark:text-emerald-400 hover:underline transition-colors duration-200">
                                View All
                            </button>
                        </div>
                            ...
                            <table className="w-full">
                                ...
                                <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                                    {popularContent.map((content) => (
                                        <tr key={content.id} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-150">
                                            ...
                                            <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-400">{content.views.toLocaleString()}</td>
                                            <td className="px-4 py-3">
                                                <div className="flex items-center">
                                                    ...
                                                    <span className="ml-2 text-xs font-medium text-gray-600 dark:text-gray-400">{content.rating}</span>
                                                </div>
                                            </td>
                                        </tr>
                                    ))}
