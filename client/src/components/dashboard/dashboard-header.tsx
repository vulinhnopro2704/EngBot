      ...
      <CardContent className="p-6 md:p-8 relative z-10">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div className="space-y-2">
            ...
            >
              It's {getDayOfWeek()}. Keep up your {streak} day streak!
            </motion.p>
          </div>

          <div className="flex items-center gap-3">
            <motion.div
              className="flex items-center gap-1.5 bg-gradient-to-r from-orange-500 to-red-500 dark:from-orange-600 dark:to-red-600 text-white px-3 py-1.5 rounded-full shadow-md"
            ...
            <motion.div
              className="flex items-center gap-1.5 bg-gradient-to-r from-red-500 to-pink-500 dark:from-red-600 dark:to-pink-600 text-white px-3 py-1.5 rounded-full shadow-md"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              initial={{ opacity: 0, x: 20 }}
              animate={{ opacity: 1, x: 0 }}
            ...
            >
              ...
              <span className="font-medium text-sm md:text-base">{hearts}</span>
            </motion.div>

            <motion.div
              className="flex items-center gap-1.5 bg-gradient-to-r from-blue-500 to-cyan-500 dark:from-blue-600 dark:to-cyan-600 text-white px-3 py-1.5 rounded-full shadow-md"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              initial={{ opacity: 0, x: 20 }}
              animate={{ opacity: 1, x: 0 }}
            ...
            >
              ...
              <span className="font-medium text-sm md:text-base">{diamonds}</span>
            </motion.div>

            <motion.div
              className="hidden md:flex items-center gap-1.5 bg-gradient-to-r from-green-500 to-emerald-500 dark:from-green-600 dark:to-emerald-600 text-white px-3 py-1.5 rounded-full shadow-md"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              initial={{ opacity: 0, x: 20 }}
              animate={{ opacity: 1, x: 0 }}
        ...
        >
          ...
          <div className="relative">
            <Progress value={percentage} className="h-3 md:h-4 bg-primary/10" />
            <motion.div
