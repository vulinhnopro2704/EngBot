...
export function EditWordDialog({
	...
	const handleRelatedWordsChange = (
		...
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
				<DialogHeader>
					...
					<DialogDescription>
						Edit the details of "{entry.word}" in your vocabulary
						notebook.
					</DialogDescription>
				</DialogHeader>
				...
				{showSuccess ? (
					...
					>
						...
						<p className="text-center text-muted-foreground">
							"{formData.word}" has been updated in your notebook
						</p>
					</motion.div>
				) : (
						...
						<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
							<div className="space-y-2">
								...
								<Input
									...
									className={
										errors.word ? "border-destructive" : ""
									}
								/>
								{errors.word && (
						...
						<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
							<div className="space-y-2">
								...
								<Select
									...
									onValueChange={(value) =>
										handleSelectChange(value, "wordType")
									}
								>
									<SelectTrigger>
