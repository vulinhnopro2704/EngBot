...
export function PracticeResultsPage() {
	...
	const { questions, correctAnswers, incorrectAnswers } =
		currentPracticeSession;
	...
	const handlePracticeSimilar = () => {
		...
		startPracticeSession(
			questions.length,
			currentPracticeSession.courseId,
			currentPracticeSession.lessonId
		);
			...
			<div className="text-center">
				...
				<p className="text-muted-foreground">
					{score >= 80
						...
						: "Keep practicing! You&lsquo ll get better with time."}
				</p>
			</div>
				...
				<Card>
					...
					<CardContent>
						...
						<p className="text-xs text-muted-foreground mt-2">
							{Math.round(timeSpent / questions.length)} seconds
							per question
						</p>
					</CardContent>
				</Card>
