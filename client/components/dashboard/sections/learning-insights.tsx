...
import { MemorizationLevelChart } from "@/components/dashboard/ui/memorization-level-chart"
import { weeklyProgress, wordCategories } from "@/data/dashboard"
      ...
      <CardContent className="p-4 md:p-6 relative">
        ...
        <div className="relative z-10">
          <Tabs defaultValue="progress" className="w-full">
            <TabsList className="grid w-full grid-cols-3 mb-4 bg-white/50 dark:bg-gray-900/50 backdrop-blur-sm h-10 md:h-12">
              <TabsTrigger
                value="progress"
              ...
              <TabsTrigger
                value="levels"
                className="text-xs md:text-sm data-[state=active]:bg-gradient-to-r data-[state=active]:from-purple-500 data-[state=active]:to-indigo-500 data-[state=active]:text-white"
              >
                Memory Levels
              </TabsTrigger>
              <TabsTrigger
