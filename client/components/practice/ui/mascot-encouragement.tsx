...
const mascotImages = {
  happy: "/placeholder.svg?height=120&width=120",
  sad: "/placeholder.svg?height=120&width=120",
  excited: "/placeholder.svg?height=120&width=120",
  neutral: "/placeholder.svg?height=120&width=120",
}

export function MascotEncouragement({ message, mood, onComplete, duration = 3000 }: MascotEncouragementProps) {
