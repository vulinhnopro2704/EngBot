...
import type { VocabularyWord, WordType, CEFRLevel } from "@/data/types"
...
export function AddWordDialog({ open, onOpenChange }: AddWordDialogProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const newWord: VocabularyWord = {
      ...
      cefr: formData.cefr as CEFRLevel,
      level: formData.level || 1,
    }

    // Add to notebook and log for debugging
    console.log("Submitting new word to notebook:", newWord)
