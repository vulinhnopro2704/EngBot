...
export function Mascot({
	...
	const bubbleClasses = {
		...
		excited:
			"bg-yellow-100 border-yellow-200 dark:bg-yellow-900/50 dark:border-yellow-800",
		neutral:
			"bg-gray-100 border-gray-200 dark:bg-gray-900/50 dark:border-gray-800",
	};
	...
	return (
		<div className="flex items-end gap-2">
			...
			<motion.div
				className={cn(
					"relative p-3 rounded-lg border shadow-sm max-w-[200px]",
					bubbleClasses[mood]
				)}
			...
			>
				...
				<div
					className={cn(
						"absolute -bottom-2 right-5 w-4 h-4 transform rotate-45",
						bubbleClasses[mood]
					)}
				/>
			</motion.div>
